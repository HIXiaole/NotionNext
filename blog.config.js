...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi, 我是一个打工人, Hi, 我是一个干饭人, 业余程序员,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小乐', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '小乐的笔记本，记录小乐学习和成长，也希望以此结实更多的前辈和好友。分享小乐在学习、编程、探索、研究等...各个领域的点点滴滴，希望与你共同进步、共同成长。', // 作者简介
