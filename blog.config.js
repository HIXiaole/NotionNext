...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎来到我的博客🎉, 我是一个打工人, 我是一个干饭人, 业余程序员',
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'im#xiaole.me（#替换成@）', // 邮箱地址 例如mail@tangly1024.com
